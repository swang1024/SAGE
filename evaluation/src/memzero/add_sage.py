...
class MemoryADDSAGE:
    """MemoryADD variant with action-level instrumentation for evaluation runs."""
    ...
    def __init__(
        ...
        embedding_dims=768,
        qdrant_path="/tmp/mem0_eval_qdrant_persist",
        history_db_path="/tmp/mem0_eval_history_persist.db",
        collection_name="mem0_eval_persist",
        enable_sage=False,
        ...
        if self.backend == "cloud":
            ...
            if is_graph:
                ...
                memory_config["graph_store"] = {
                    "provider": "kuzu",
                    "config": {"db": f"/tmp/mem0_eval_kuzu_{collection_name}"},
                }
